...
//===========Change by Colddream============================
//@interface KGModalContainerView : UIView //origin
@interface KGModalContainerView : UIScrollView
...
-(void)setContainerViewMovedUpWithOffset:(CGFloat)offset
{
...
//method to move the view up/down whenever the keyboard is shown/dismissed
-(void)setContainerViewMovedDownToOrigin
{
    [UIView beginAnimations:nil context:NULL];
    [UIView setAnimationDuration:0.3]; // if you want to slide up the view
...
- (void)showWithContentView:(UIView *)contentView andAnimated:(BOOL)animated {
    ...
    KGModalContainerView *containerView = [[KGModalContainerView alloc] initWithContentViewFrame:containerViewRect];
	//===========Change by Colddream============================
...
- (void)hideAnimated:(BOOL)animated withCompletionBlock:(void(^)())completion{
    if(!animated){
		//===========Change by Colddream============================
		if ([self.delegate respondsToSelector:@selector(hideWithContentView:)]) {
			[self.delegate hideWithContentView:self.contentView];
		}
		//===========Change by Colddream============================
...
- (instancetype)initWithContentViewFrame:(CGRect)frame{
    ...
    self.maxHeight = bounds.size.height - (44);
    ...
    if (frame.size.height > self.maxHeight) {
        ...
        frame.origin.y += (frame.size.height - self.maxHeight)/2;
        frame.size.height = self.maxHeight;
        self.frame = frame;
    }
    
    CALayer *styleLayer = self.layer;
